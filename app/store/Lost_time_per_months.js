Ext.define('helloext.store.Lost_time_per_months', { //parameter pertama harus sesuai filepath
    extend: 'Ext.data.Store',
    model: 'helloext.model.Lost_time_per_month',
    autoLoad:true,
    autoSync: true,
    // remoteSort: true,
    proxy: {
        ...
        url: 'http://'+helloext.util.Config.hostname()+'/daily_output/public/api/lost_times/permonth',
        reader:{
            root: 'data',
            type: 'json',
            // totalProperty: 'total',
